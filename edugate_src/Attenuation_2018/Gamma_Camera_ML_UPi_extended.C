...
// Gamma_Camera_ML_UPi_extended.C
// Macro for the evaluation of the Gamma_Camera_ML_UPi_extended EduGATE example.
...

{
    ...
    proc_code = new TH1F("Process_Code","",128,0.,128.);
            ...
            //    cout<< runID <<" "<< runID_hits<< " "<< eventID <<" "<< eventID_hits <<" "<< ih_last <<" "<< ih <<" "<< ihits <<endl;
                ...
                if (eventID == eventID_hits) {
                 ...
                 //   cout<< runID_hits <<" "<< eventID_hits <<" "<< ih <<" "<< ihits <<" "<<PDGEncoding <<" "<< energy <<" "<< processName <<endl;
                    ...
                    if (strcmp(processName,"msc")==  0) {
                        MultScat++;
                        ProcFlag = 1;
                    }
                    if (strcmp(processName,"ElectronIonisation")==  0) {
                        ElecIon++;
                        ProcFlag = ProcFlag + 2;
                    }
                    ...
                    if (strcmp(processName,"Bremsstrahlung")==  0) {
                        Brems++;
                        ProcFlag = ProcFlag + 8;
                    }
                    if (strcmp(processName,"PhotoElectric")==  0) {
//                    if (strcmp(processName,"phot")==  0) {
                        Photo++;
                        ProcFlag = ProcFlag + 16;
                    }
                    if (strcmp(processName,"Compton")==  0) {
//                    if (strcmp(processName,"compt")==  0) {
                        Compt++;
                        ProcFlag = ProcFlag + 32;
                    }
                    if (strcmp(processName,"Rayl")==  0) {
                        RaylScat++;
	...
	cout << endl;
	if (ordertot > 0) {
        cout<<"##### Scatter order total :      "       <<ordertot<<endl;
...
void Gamma_Camera_ML_UPi_extended()
{
   // Popup the GUI...
