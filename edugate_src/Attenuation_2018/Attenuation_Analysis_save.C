...
// Macro for the evaluation of the Attenuation_Analysis EduGATE example.
...

{
	...
	fEcanvas = new TRootEmbeddedCanvas("Ecanvas",fMain,1050, 1000); 
	...
	fMain->SetWindowName("Attenuation");
