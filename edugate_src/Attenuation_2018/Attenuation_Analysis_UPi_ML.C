...
public:
   ...
   void CloseWindow();
   void ChooseFile();
   void  Attenuation_Analysis(TString fname);
...
void MyMainFrame:: Attenuation_Analysis(TString fname)
{
...
//    ordertot = 0.;
    ...
    cout << endl;
    cout << "##### maximum_energy (MeV)    : " << " " <<  maximum_energy << endl;
    cout << "##### Emax for Histogram (MeV): " << " " <<  Emax << endl;
    cout << endl;
 ...
 //   osup->SetBins(100,0,Emax);
    ...
    cout<<"##### nb of primaries (ntotal) i.e. nb of emmitted particles: " << ntotal <<endl;
    cout<<"##### nb of entries i.e. nb of detected particles: " << nentries <<endl;
    cout << endl;
	...
	o1->SetTitle("Detection vs Energy of 5 sources");
...
//	leg2->AddEntry(osup,">4st order scatter","l");
	...
	cout << " *   A T T E N A T I O N                                                           * " << endl;
	cout << " *                                                                                 * " << endl;
	cout << " *********************************************************************************** " << endl;
	cout << endl;

    Int_t nsource_avg;
    nsource_avg = ntotal/5;
    
    cout<<"##### Number of emitted particles              :  "	<<ntotal   <<endl;
    cout<<"##### Number of emitted particles per source   :  "  <<nsource_avg<<endl;
    cout<<"##### Number of detected events                :  "	<<nentries <<endl;
    
    // Primary -> ni scatter in phantom or crystal
    cout<<"##### Primary / unscattered events             :  "	<<primary_event       <<endl;
    cout<<"##### Scatter in the crystal                   :  "	<<scatter_crystal     <<endl;
    cout << endl;
    
	if (ntotal > 0) {
        
        cout<<"##### detected event per source; i.e. per energy value "  <<endl;
		cout<<"##### source 1    :      "       <<order1   <<endl;
		cout<<"##### source 2    :      "       <<order2   <<endl;
		cout<<"##### source 3    :      "       <<order3   <<endl;
		cout<<"##### source 4    :      "       <<order4   <<endl;
		cout<<"##### source 5    :      "       <<order5   <<endl;
        cout << endl;

        cout<<"##### detected event per source; i.e. per energy value (%)"  <<endl;
        cout<<"##### source 1    :      "       <<order1/nsource_avg*100   <<endl;
        cout<<"##### source 2    :      "       <<order2/nsource_avg*100   <<endl;
        cout<<"##### source 3    :      "       <<order3/nsource_avg*100   <<endl;
        cout<<"##### source 4    :      "       <<order4/nsource_avg*100   <<endl;
        cout<<"##### source 5    :      "       <<order5/nsource_avg*100   <<endl;
...
void TestFileList::DisplayFile(const TString &fname)
{
   // Display content of ROOT file.
	cout<<fname<<endl;
	pmain-> Attenuation_Analysis(fname);
	fMain->CloseWindow();
