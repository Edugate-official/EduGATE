...
{	
	...
	for (int i=0; i<numCombo; i++) {
		...
		cout<<"/control/alias RootFileName MR_PET_{Camera_Type}_{Medium}_{SourceEnergy}_{particle}_{SourceActivity}_{Source_Type}_{B0_x}_{B0_y}_{B0_z}_{Annihilation}"<<endl;
		fout<<"/control/alias RootFileName MR_PET_{Camera_Type}_{Medium}_{SourceEnergy}_{particle}_{SourceActivity}_{Source_Type}_{B0_x}_{B0_y}_{B0_z}_{Annihilation}"<<"\n";
